...
if __name__ == "__main__":
    ...
    faults, history = fifo_page_replacement(pages, frame_size)
    visualize_terminal(pages, frame_size, "FIFO", faults, history)
    visualize_gui(pages, frame_size, "FIFO", faults, history)
