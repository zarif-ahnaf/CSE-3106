...
if __name__ == "__main__":
    ...
    faults, history = optimal_page_replacement(pages, frame_size)
    visualize_terminal(pages, frame_size, "Optimal", faults, history)
    visualize_gui(pages, frame_size, "Optimal", faults, history)
